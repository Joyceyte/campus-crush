    ...
    <>
      ...
      <main id="main-content" style={{ background: "var(--navy-dark)", paddingTop: "8rem", paddingBottom: "5rem" }}>
        <div style={{ maxWidth: "42rem", margin: "0 auto", padding: "0 1.5rem" }}>
          <h1 style={{ fontSize: "2rem", marginBottom: "0.5rem", color: "#fff" }}>Campus Crush Blog</h1>
          <p style={{ marginBottom: "2.5rem", color: "rgba(255,255,255,0.55)", fontSize: "0.95rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            {posts.map((post) => (
              ...
              >
                ...
                <h2 style={{ fontSize: "1.25rem", marginBottom: "0.5rem", color: "#fff" }}>{post.title}</h2>
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: 1.55 }}>
                  {post.excerpt}
                </p>
              </Link>
            ))}
