...
**Domain:** Adding Supabase Auth (Google OAuth), profile onboarding, and private file storage to an existing Next.js 16 App Router app
**Researched:** 2026-08-03
**Confidence:** MEDIUM (core patterns cross-checked across official Supabase docs + multiple independent guides; no context7/MCP docs access in this environment — see Gaps)
...
**Deliberately not adding:** a form library (React Hook Form, Formik), a state manager, or a file-uploader package. The onboarding form is a handful of steps with plain fields; pulling in extra dependencies here would be scope creep for a pilot. Revisit only if the form grows materially more complex.
...
No dev dependencies needed for this milestone.
...
**If a user signs in with Google but their email domain isn't allow-listed:**
...
**If a returning user has an incomplete or complete profile:**
...
---
*Stack research for: Supabase Auth + Storage + RLS addition to Next.js 16 App Router pilot app*
*Researched: 2026-08-03*
