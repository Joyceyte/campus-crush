...
export default function WhyUs() {
  return (
    <>
      {/* ── Anti-App: deliberately cold and generic, the opposite of the rest
           of this site's warm parchment/scrapbook identity. No photo, no
           torn-paper card, no terracotta headings — this section is
           describing everyone else's product, not ours, and it should look
           like it. The contrast sells "we're different" better than any
           copy could. ── */}
      <section
        id="why-us"
      ...
      >
        <div className="relative" style={{ zIndex: 5, padding: "0 1.25rem" }}>
          <div className="cols-2" style={{ maxWidth: "56rem", gap: "2.5rem" }}>
            {/* Left column */}
            <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem", textAlign: "center" }}>
              ...
              >
                Swipe culture wasn&apos;t built for real connections.
              </p>
            </div>

            {/* Right column — notification chaos graphic, scaled down as a
                whole rather than resizing each card's own offsets */}
            <div
              aria-hidden="true"
              style={{
                position: "relative",
            ...
            >
            <div style={{ position: "absolute", top: 0, left: 0, width: "300px", height: "280px", transform: "scale(0.75)", transformOrigin: "top left" }}>
              {notifications.map((n, i) => (
                <div
                  ...
                  style={{
                    ...
                    flexDirection: "column",
                    gap: "0.2rem",
                    boxShadow: "0 8px 20px rgba(30,30,40,0.08)",
                  }}
                >
      ...
      {/* ── Matchmaker: back to the warm, on-brand treatment ── */}
      <section
